...
const CapitolToursWebsite = () => {
  ...
  const tours = [
    ...
    },
    {
      ...
      image: '/img/unsplash_7v5tTcjD928.png'
    }
  ];
  ...
  const galleryImages = [
    { id: 1, src: '/gg/1.png', alt: 'Mountain Vista', category: 'Adventure' },
    { id: 2, src: '/gg/2.png', alt: 'Family at Museum', category: 'Family' },
    { id: 3, src: '/gg/3.png', alt: 'Ancient Temple', category: 'Historical' },
    { id: 4, src: '/gg/4.png', alt: 'Luxury Suite', category: 'Luxury' },
    { id: 5, src: '/gg/5.png', alt: 'Group Photo', category: 'Adventure' },
    { id: 6, src: '/gg/6.png', alt: 'Cultural Performance', category: 'Family' }
  ];
        ...
        <div className="max-w-6xl mx-auto px-4">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  ...
                  <span>info@capitoltours.com</span>
                </div>
                <div className="flex items-center">
                  <MapPin className="w-5 h-5 text-blue-600 mr-3" />
                  <span>123 Capitol Street, Tourism District, City 12345</span>
                </div>
                <div className="flex items-center">
          ...
          <div className="mt-12">
            ...
            <div className="bg-gray-300 h-64 rounded-lg flex items-center justify-center">
              <span className="text-gray-600">Google Map would be embedded here</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="space-y-2 text-gray-300">
                ...
                <p className="flex items-center"><Mail className="w-4 h-4 mr-2" />info@capitoltours.com</p>
                <p className="flex items-center"><MapPin className="w-4 h-4 mr-2" />123 Capitol Street, Tourism District</p>
          ...
          <div className="md:flex md:justify-between md:items-center">
            <div className="mb-4 md:mb-0">
              <p className="text-gray-300">&copy; 2025 Capitol Hospitality & Tours. All rights reserved.</p>
            </div>
